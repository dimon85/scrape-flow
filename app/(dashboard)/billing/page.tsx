...
const BillingPage = () => {
  return (
    <div className="mx-auto p-4 space-y-9">
    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        {purchases.map((purchase) => (
          <div key={purchase.id} className="flex justify-between items-center border-b last:border-b-0 py-3">
            <div>
